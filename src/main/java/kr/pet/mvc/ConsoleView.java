...
public class ConsoleView {
    ...
    public  Customer getCustomerInfo(){
        ...
        scanner.nextLine(); // Consume the newLine charcter left by nextInt()
    ...
    public void printMedicalRecordInfo(Customer customer){
        ...
        System.out.println("["+customer.getPetName()+"]님의 진료기록");
        for(MedicalRecord record : records){
            System.out.println("진료일 : "+record.getDate());
            System.out.println("진료내용 : " +record.getContent());
            System.out.println("소유주내용 : " + customer.getOwnerName());
